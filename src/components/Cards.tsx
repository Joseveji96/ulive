...
function Cards() {
  return (
    <div className='flex justify-between'>
      <div className="relative w-[400px] h-[520px] rounded-xl overflow-hidden shadow-card hover:shadow-card-hover transition-shadow duration-300 mt-4 p-4">
      {/* Imagen de fondo */}
    ...
    <div className="relative w-[400px] h-[520px] rounded-xl overflow-hidden shadow-card hover:shadow-card-hover transition-shadow duration-300 mt-4 p-4">
      ...
      {/* Capa de gradiente y texto */}
      <div className="absolute bottom-0 left-0 right-0 p-6 pb-12 bg-gradient-to-t from-black/70 via-transparent z-10">
        <h3 className="text-white text-6xl font-light uppercase">Celebrities</h3>
