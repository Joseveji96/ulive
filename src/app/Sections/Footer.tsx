...
const Footer = () => {
  ...
  return (
    <footer
      ref={ref}
      className='relative h-[92vh] p-4 md:p-8 lg:p-16 bg-black flex flex-col justify-between overflow-hidden'
      id='more'
    >
      <motion.div
      ...
      >
        {/* Hero Section */}
        <div className='w-full flex flex-col lg:flex-row items-center gap-16 lg:gap-20 mb-20'>
          {/* Image with Modern Frame */}
          <motion.div
            className="relative group"
            variants={itemVariants}
          >
            <div className="relative w-[500px] h-[320px] lg:w-[584px] lg:h-[371px] overflow-hidden">
          ...
          >
            <div className="relative">
              <h1 className='font-bold text-6xl md:text-8xl lg:text-[280px] text-transparent bg-clip-text bg-gradient-to-r from-white via-cafe to-cafe leading-none'>
                Ulive
              </h1>
            </div>
